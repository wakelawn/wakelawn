...
## wakelawn$  cat about.txt

    ┌──(wakelawn)-[~]
    └─$ whoami
     Md Raj Islam — Java craftsman by day, bug hunter by night.
    └─$ cat mission.txt
      > traget  : GOOGLE
    ...
    └─$ sudo ./launch_portfolio.sh
      portfolio-three-umber-arnvii9myq.vercel.app 
    └─$ rm -rf doubts/
      removed 'doubts' successfully

---

## wakelawn$ cat boot.log
...
## wakelawn$$ nmap -sV raj.islam

    Starting Nmap 7.94 ( https://nmap.org )
    Nmap scan report for raj-os (10.0.0.42)
    Host is up (0.066s latency).        # 999ms — it's a sign
    ...
    3000/tcp   open   portfolio   → portfolio-three-umber-arnvii9myq.vercel.app 
